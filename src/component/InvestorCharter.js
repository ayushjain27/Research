...
const InvestorCharter = () => {
  ...
  const tabs = [
    ...
    { id: "responsibilities", title: "Investor Responsibilities", ref: responsibilitiesRef },
  ...
  //             <h3 className="text-2xl font-bold text-teal-800 mb-4">Vision</h3>
  ...
  //             <h4 className="text-xl font-semibold text-teal-700 mb-3">Do's</h4>
  ...
  //                   >
  //                     (SEBI Website) <ExternalLink className="inline w-4 h-4" />
  //                   </a>
  //                 </div>
  //               </li>
  //               <li>
  ...
  //               Formats for investors complaints data to be disclosed monthly by
  //               RAs on their website/mobile application:
  //             </h4>
  ...
  //                 to impersonation by some other entity:
  //               </p>
  //               <p className="mt-2">
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-0 py-8">
        <div className="bg-white rounded-none shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div className="p-6 md:p-8 space-y-16 max-h-[calc(100vh-200px)] overflow-y-auto">
