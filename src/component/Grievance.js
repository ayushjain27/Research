...
const GrievanceRedressal = () => {
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-b-lg shadow-sm border border-gray-200 overflow-y-auto p-6 mt-16" style={{ maxHeight: 'calc(100vh - 200px)' }}>
          {/* Steps Section */}
          <div className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li>
                If you are not satisfied with the services provided and would like to lodge a complaint, 
                reach out to the Research Analyst's team at the below mentioned details.
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                Link to SCORES Portal <ExternalLink className="w-4 h-4 ml-1" />
              </a>
            </div>
