      ...
      <div className="max-w-7xl mt-16 mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-b-lg shadow-sm border border-gray-200 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 200px)' }}>
          ...
          <div className="p-6 md:p-8 space-y-4">
            ...
            <section className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-lg">
              <h2 className="text-xl font-bold text-gray-800 mb-2">What We Collect</h2>
              <div className="space-y-1 text-gray-700">
            ...
            {/* Data Usage Section */}
            <section className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-lg">
              <h2 className="text-xl font-bold text-gray-800 mb-2">What We Do With Your Information</h2>
              <div className="space-y-1 text-gray-700">
                <p>
            ...
            {/* Cookies Section */}
            <section className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-lg">
              <h2 className="text-xl font-bold text-gray-800 mb-2">How We Use Cookies</h2>
              <div className="space-y-1 text-gray-700">
                <p>
            ...
            {/* Links Section */}
            <section className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-lg">
              <h2 className="text-xl font-bold text-gray-800 mb-2">Links to Other Websites</h2>
              <div className="space-y-1 text-gray-700">
                <p>
            ...
            <section className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-lg">
              <h2 className="text-xl font-bold text-gray-800 mb-2">Controlling Your Personal Information</h2>
              <div className="space-y-1 text-gray-700">
                <p>
            ...
            {/* Media Section */}
            <section className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-lg">
              <h2 className="text-xl font-bold text-gray-800 mb-2">Media</h2>
              <div className="space-y-1 text-gray-700">
                <p>
            ...
            <section className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-lg">
              <h2 className="text-xl font-bold text-gray-800 mb-2">Contact Forms</h2>
              <div className="space-y-1 text-gray-700">
                <p>
            ...
            <section className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-lg">
              <h2 className="text-xl font-bold text-gray-800 mb-2">Embedded Content</h2>
              <div className="space-y-1 text-gray-700">
                <p>
            ...
            <section className="bg-gradient-to-r from-blue-50 to-teal-50 p-6 rounded-lg border border-blue-200">
              <h2 className="text-xl font-bold text-blue-800 mb-2">Your Rights Over Your Data</h2>
            ...
            <section className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-lg">
              <h2 className="text-xl font-bold text-gray-800 mb-2">Where We Send Your Data</h2>
              <div className="space-y-1 text-gray-700">
                <p>
