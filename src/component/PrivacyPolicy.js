        ...
        <div>
          <section className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 md:p-6 rounded-lg">
            ...
            <div className="space-y-2 text-gray-700 text-sm md:text-base">
              <p>
                This privacy policy sets out how Abishek Kondagunta Venkatesh
                uses and protects any information that you give Abishek
                Kondagunta Venkatesh when you use this website.
              </p>
              <p>
                Abishek Kondagunta Venkatesh is committed to ensuring that your
              ...
              <p>
                Abishek Kondagunta Venkatesh may change this policy from time to
          ...
          <section className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 md:p-6 rounded-lg">
            ...
            <div className="space-y-2 text-gray-700 text-sm md:text-base">
              ...
              <p>
                ...
                you please contact us by clicking here If you believe that any
          ...
          <section className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 md:p-6 rounded-lg">
            ...
            <div className="space-y-3 text-gray-700 text-sm md:text-base">
              ...
              <p>
                <strong>Industry regulatory disclosure requirements:</strong> As
                a SEBI registered Research Analyst, we comply with all
                applicable regulations regarding data protection and privacy.
              </p>
            </div>
          </section>
