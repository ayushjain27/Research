      ...
      <div className="p-4 md:p-6 space-y-6 max-h-[600px] overflow-y-auto">
        ...
        <section ref={applicabilityRef} className="scroll-mt-24">
          <div className="space-y-2">
            ...
            <div className="text-gray-700 text-sm md:text-base">
              <p>
                This policy shall be applicable to Research Analyst Abishek
                Kondagunta Venkatesh holding SEBI Registration No INH000022066
          ...
          <div className="space-y-2">
            ...
            <div className="text-gray-700 text-sm md:text-base">
              ...
              <div className="mt-4 text-right">
                <p className="font-medium">Mr. Abishek Kondagunta Venkatesh</p>
                <p>Place: Hyderabad</p>
