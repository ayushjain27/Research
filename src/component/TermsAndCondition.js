      ...
      >
        ...
        <main role="main">
          <section className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 md:p-6 rounded-lg">
            ...
            <div className="space-y-2 text-gray-700 text-sm md:text-base">
              <p>
                ...
                Kondagunta Venkatesh ("Research Analyst") registered with the
                Securities and Exchange Board of India (SEBI) as a Research
                Analyst (RA) under registration No. INH000022066; BSE Enlistment
                No. 6652;
              </p>
              <p>
          ...
          <section className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 md:p-6 rounded-lg">
            ...
            <div className="space-y-3 text-gray-700 text-sm md:text-base">
              ...
              <p>
                ...
                client shall be bound by SEBI Act and all the applicable rules
                and regulations of SEBI, including the RA Regulations and
                relevant notifications of the Government, as may be in force,
                from time to time.
              </p>
              ...
              <p>
                ...
                its standard form with supporting details, if required, as may
              ...
              <div className="bg-gradient-to-r from-blue-50 to-teal-50 p-3 md:p-4 rounded-lg border border-blue-200">
                <p className="text-blue-800 text-sm md:text-base">
                  ...
                  the KYC Registration Agency (KRA) as specified by SEBI from
                  time to time.
                </p>
              </div>
              ...
              <p>
                ...
                our services, the Client acknowledges and agrees to the
                following:
              </p>
              ...
              <ul className="list-disc pl-5 space-y-2 italic">
                ...
                <li>
                  ...
                  our own judgement and assessment of the conclusions per our
                  own judgement and assessment of the conclusions contained in
                  the research report."
                </li>
                <li>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-teal-50 p-3 md:p-4 rounded-lg border border-blue-200">
                ...
                <ul className="list-disc pl-5 space-y-2 text-blue-700 text-sm md:text-base">
                  <li>
                    ...
                    registration no. INH000022066 from July 28, 2025; BSE
                    enlistment no. 6652 and compliant with the SEBI (research
                  ...
                  <li>
                    We have no material adverse disciplinary history or any
              ...
              <p>
                ...
                services that RA renders to the client and statutory charges; as
                applicable. Such fees and statutory charges shall be payable
                through the specified manner and modes communicated by the
                Research Analyst (including but not limited to payment gateways
                or processors like Razorpay, NEFT, Centralised Fee Collection
                Mechanism for RA, etc.). We may collect upto one year advance
              ...
              <p>
                ...
                assurance of returns to clients.
              </p>
              ...
              <p>
                <strong>8. Termination of service and refund of fees:</strong>{" "}
                The research analyst reserves the right to suspend or terminate
                the provision of research services to clients in the event of
              ...
              <div className="bg-gradient-to-r from-blue-50 to-teal-50 p-3 md:p-4 rounded-lg border border-blue-200">
                <p className="text-blue-800 text-sm md:text-base">
                  ...
                  analyst is suspended for a period exceeding sixty (60) days or
                  is cancelled, the research analyst shall refund the
              ...
              <p>
                ...
                reports and related information are confidential and intended
                solely for the subscriber. Unauthorized distribution,
                ...
                Research Analyst assumes no responsibility for any losses
                incurred.
              </p>

              <p>
                <strong>11. Mandatory Notice:</strong> Clients shall be
                requested to go through Do's and Don'ts while dealing with RA as
                specified in SEBI master circular no.
                SEBI/HO/MIRSD-POD-1/P/CIR/2024/49 dated May 21, 2024 or as may
            ...
            <div className="space-y-2 text-blue-700 text-sm md:text-base">
              <ol className="list-decimal pl-5 space-y-2">
                ...
                <li>
                  ...
                  the RA services by either the client or the RA, the client
                ...
                <li>
                  ...
                  potential conflict of interest. The RA will endeavor to
                  promptly inform the client of any conflict of interest that
                ...
                <li>
                  ...
                  reports are subject to market risks, and recommendations do
                ...
                <li>
                  Clients are required to keep contact details, including email
                ...
                <li>
                  ...
                  Account. Never share such information with anyone including
                  RA.
                </li>
                <li>
                  <strong>
                  ...
                  <ul className="list-disc pl-5 mt-2 space-y-1">
                    <li>
                      ...
                      the payment of fees. Clients opting for this mechanism
                      will be provided with necessary guidance and instructions
                ...
                <li>
                  ...
                  <ul className="list-disc pl-5 mt-2 space-y-1">
                    <li>
                      ...
                      recommendations provided to clients. In accordance with
                      Regulation 24(7) of the SEBI (Research Analyst)
                      Regulations, 2014:
                      <ul className="list-disc pl-5 mt-2 space-y-1">
                        <li>
                        ...
                        <li>
                          We ensure compliance with applicable laws regarding
                          the use of AI tools.
                        </li>
                      </ul>
                    </li>
          ...
          <section className="bg-gradient-to-r from-blue-50 to-teal-50 p-4 md:p-6 rounded-lg border border-blue-200">
            ...
            <div className="space-y-2 text-blue-700 text-sm md:text-base">
              <p>
                Neither any research service will be rendered nor any fee will
                be charged until consent is received from client on these terms
                and conditions.
              </p>
              <p>
